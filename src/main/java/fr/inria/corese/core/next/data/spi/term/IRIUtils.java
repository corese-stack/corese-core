...
public final class IRIUtils {
    ...
    private static final String ROOT_NAMESPACE_GROUP = "rootnamespace";
    private static final String PATH_GROUP = "path";
    private static final String FINAL_PATH_GROUP = "finalPath";
    private static final String ANCHOR_GROUP = "anchor";
    private static final String FRAGMENT_GROUP = "fragment";
    ...
    public static String guessNamespace(String iri) {
        ...
        try {
            ...
            if (matcher == null || !matcher.matches()) {
                if (iri.endsWith(SLASH) || iri.endsWith(HASH)) {
                    return iri;
                ...
                if (matcher.group(PROTOCOL_GROUP) != null && matcher.group(PROTOCOL_GROUP).equals("_")) {
                    return "";
                }

                StringBuilder namespace = new StringBuilder();
                namespace.append(matcher.group(ROOT_NAMESPACE_GROUP));
                if (matcher.group(PATH_GROUP) != null) {
                    namespace.append(matcher.group(PATH_GROUP));
                }
                if (matcher.group(ANCHOR_GROUP) != null) {
                    if (matcher.group(FINAL_PATH_GROUP) != null) {
                        namespace.append(matcher.group(FINAL_PATH_GROUP));
                    }
                    namespace.append(matcher.group(ANCHOR_GROUP));
                }
    ...
    public static String guessLocalName(String iri) {
        ...
        try {
            ...
            if (matcher == null || !matcher.matches()) {
                ...
                if (matcher.group(ANCHOR_GROUP) != null) {
                    return matcher.group(FRAGMENT_GROUP) != null ? matcher.group(FRAGMENT_GROUP) : "";
