...
public abstract class CoreseNumber extends CoreseDatatype {
    ...
    static final Datatype code = Datatype.NUMBER;
    ...
    IDatatype result(IDatatype dt, long res) {
        ...
        if (getDatatypeURI().equals(XSD.xsdLong.getIRI().stringValue()) && dt.getDatatypeURI().equals(XSD.xsdLong.getIRI().stringValue())) {
