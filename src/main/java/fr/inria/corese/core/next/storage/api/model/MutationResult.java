...
public final class MutationResult {
    ...
    /**
     * Returns all affected statements.
     *
     * @return an immutable list, empty when no statement was affected
     */
    ...
    public String toString() {
        if (isBulk) {
            ...
            if (success) {
                return "MutationResult{success=true, statement=" + getAffectedStatement().orElse(null) +
                        ", message='" + message + "'}";
            } else {
     ...
     */
    public static final class MutationError {
    ...
    public static final class BulkBuilder {
        ...
        public MutationResult build() {
            if (totalAttempted < 0 || successCount < 0 || failureCount < 0) {
                throw new IllegalStateException("Mutation counts cannot be negative");
            }
            if (successCount + failureCount != totalAttempted) {
                throw new IllegalStateException(
                        "Successful and failed mutations must equal total attempted mutations");
            }
