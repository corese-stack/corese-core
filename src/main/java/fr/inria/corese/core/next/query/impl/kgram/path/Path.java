...
import fr.inria.corese.core.next.query.impl.kgram.tool.ProducerDefault;

import java.util.ArrayList;
import java.util.List;

import static fr.inria.corese.core.next.query.impl.kgram.api.core.PointerType.PATH;
