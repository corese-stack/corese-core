...
public final class SimpleDateTime extends AbstractTemporalPointLiteral {
    ...
    public SimpleDateTime(XMLGregorianCalendar calendar) {
        super(XSDDatatype.DATETIME.getIRI());
    ...
    protected void setCoreDatatype(CoreDatatype coreDatatype) {
        throw new IncorrectOperationException("SimpleDateTime is immutable");
    }
