package fr.inria.corese.core.next.kgram.sorter.impl.qpv1;
...
import fr.inria.corese.core.next.kgram.sorter.core.AbstractCostModel;
import fr.inria.corese.core.next.kgram.sorter.core.Const;
import static fr.inria.corese.core.next.kgram.sorter.core.Const.BOUND;
import static fr.inria.corese.core.next.kgram.sorter.core.Const.LIST;
import static fr.inria.corese.core.next.kgram.sorter.core.Const.NA;
import static fr.inria.corese.core.next.kgram.sorter.core.Const.PREDICATE;
import static fr.inria.corese.core.next.kgram.sorter.core.Const.UNBOUND;
import fr.inria.corese.core.next.kgram.sorter.core.QPGNode;
import fr.inria.corese.core.next.kgram.sorter.core.QPGraph;
import static fr.inria.corese.core.next.kgram.sorter.core.IEstimate.MAX_COST;
import static fr.inria.corese.core.next.kgram.sorter.core.IEstimate.MIN_COST_0;
