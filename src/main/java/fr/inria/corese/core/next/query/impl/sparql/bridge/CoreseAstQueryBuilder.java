 ...
 * or complete {@code QueryAst} into legacy KGRAM objects is future work (required for
...
public final class CoreseAstQueryBuilder {
    ...
    /**
     * Converts a filter term (boolean expression) from the next parser into a legacy
     * {@link fr.inria.corese.core.sparql.triple.parser.Expression}, then exposes it as a Corese-next
