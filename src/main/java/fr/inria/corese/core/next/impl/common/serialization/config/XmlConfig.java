...
public class XmlConfig extends AbstractSerializerConfig {
     ...
     */
    public static class Builder extends AbstractSerializerConfig.AbstractBuilder<Builder> {
        ...
        /**
         * Builds and returns a new {@link XmlConfig} instance with the current builder settings.
         *
     ...
     */
    public static XmlConfig defaultConfig() {
