...
public abstract class AbstractSerializerOptions implements IOOptions, BaseIRIOptions, LineEndingOptions, BlankNodeIdGenerationOptions, DatatypePolicyOptions {
     ...
     */
    protected final LiteralDatatypePolicy literalDatatypePolicy;
    /**
    ...
    public abstract static class AbstractBuilder<S extends AbstractBuilder<S>> {
        protected LiteralDatatypePolicy literalDatatypePolicy = LiteralDatatypePolicy.MINIMAL;
         ...
         *
         * @param policy The {@link LiteralDatatypePolicy} to set. Must not be null.
         * @return The builder instance for fluent chaining.
         * @throws NullPointerException if the provided policy is null.
         */
        public S literalDatatypePolicy(LiteralDatatypePolicy policy) {
