...
import fr.inria.corese.core.next.generated.antlr.SparqlParserListener;

import java.util.Collections;
import java.util.List;

/**
 * Dispatches the supported ANTLR SPARQL parse-tree events to a fixed list of delegates.
 *
 ...
 */
final class SparqlAntlrDispatcher extends SparqlParserBaseListener {

    private final List<? extends SparqlParserListener> delegates;

    SparqlAntlrDispatcher(List<? extends SparqlParserListener> delegates) {
    ...
    // ---------- GROUP GRAPH PATTERN ----------
    @Override
    public void enterGroupGraphPattern(fr.inria.corese.core.next.generated.antlr.SparqlParser.GroupGraphPatternContext ctx) {
        for (var d : delegates) d.enterGroupGraphPattern(ctx);
    }

    @Override
    public void exitGroupGraphPattern(fr.inria.corese.core.next.generated.antlr.SparqlParser.GroupGraphPatternContext ctx) {
        for (var d : delegates) d.exitGroupGraphPattern(ctx);
    }

    // ---------- TRIPLES BLOCK (BGP boundary) ----------
    @Override
    public void enterTriplesBlock(fr.inria.corese.core.next.generated.antlr.SparqlParser.TriplesBlockContext ctx) {
        for (var d : delegates) d.enterTriplesBlock(ctx);
    }

    @Override
    public void exitTriplesBlock(fr.inria.corese.core.next.generated.antlr.SparqlParser.TriplesBlockContext ctx) {
    ...
    public void enterMove(SparqlParser.MoveContext ctx) {
        for (var d : delegates) d.enterMove(ctx);
    }
