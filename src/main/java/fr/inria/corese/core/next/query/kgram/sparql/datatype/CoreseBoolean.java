...
public class CoreseBoolean extends CoreseStringLiteral {
    ...
    static Datatype code = Datatype.BOOLEAN;
    ...
    static final CoreseURI datatype = new CoreseURI(XSD.xsdBoolean.getIRI().stringValue());
    boolean bvalue = true;
    ...
    public boolean equalsWE(IDatatype iod) throws CoreseDatatypeException {
        ...
        throw new CoreseDatatypeException("Equality evaluation was not possible");
    }
    ...
    public boolean less(IDatatype dt) throws CoreseDatatypeException {
        ...
        throw new CoreseDatatypeException("Comparison evaluation was not possible");
    }
