...
import static fr.inria.corese.core.next.query.kgram.sparql.datatype.DatatypeMap.TRUE;
...
public class CoreseDouble extends CoreseNumber {
    ...
    static final fr.inria.corese.core.next.query.kgram.sparql.datatype.CoreseURI datatype = new CoreseURI(XSD.xsdDouble.getIRI().stringValue());
    static final Datatype code = Datatype.DOUBLE;
    ...
    public IDatatype eq(IDatatype dt)  {
        switch (dt.getCode()) {
            ...
            case FLOAT:
            case DOUBLE:
                return (IDatatype) ((dvalue == dt.doubleValue()) ? TRUE : FALSE);
    ...
    public IDatatype neq(IDatatype dt) {
         switch (dt.getCode()) {
            ...
            case FLOAT:
            case DOUBLE:
                return (IDatatype) ((dvalue == dt.doubleValue()) ? FALSE : TRUE);
    ...
    public IDatatype lt(IDatatype iod) {
        switch (iod.getCode()) {
            ...
            case FLOAT:
            case DOUBLE:
                return (IDatatype) ((dvalue < iod.doubleValue()) ? TRUE : FALSE);
            default:
                return null;
        }
    }
