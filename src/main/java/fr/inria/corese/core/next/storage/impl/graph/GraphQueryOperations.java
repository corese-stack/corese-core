...
/**
 * Query operations implementation for {@link GraphStorageManager}.
 */
final class GraphQueryOperations implements QueryOperations {
    ...
    public Model filter(StatementPattern pattern) throws StorageException {
        throw new UnsupportedOperationException(
                "filter() not implemented for GraphStorageManager. " +
                        "Would require creating a new Model from filtered results."
        );
    }
}
