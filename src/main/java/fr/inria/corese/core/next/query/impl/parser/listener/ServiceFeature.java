 ...
 * The inner {@code groupGraphPattern} is handled by {@link BgpFeature} via the
 ...
 */
public class ServiceFeature extends AbstractSparqlFeature {

    /**
     * Constructs a {@code ServiceFeature} bound to the given AST builder.
     *
     * @param builder the {@link SparqlAstBuilder} that will receive SERVICE lifecycle events
     */
    public ServiceFeature(SparqlAstBuilder builder) {
        super(builder);
    }
