package fr.inria.corese.core.next.query.impl.sparql.parser.semantic.validator;
...
import fr.inria.corese.core.next.query.impl.sparql.parser.semantic.rule.*;
...
public final class SparqlQuerySemanticValidator implements QueryValidator<QueryAst> {
    ...
    public SparqlQuerySemanticValidator() {
        this(List.of(
                ...
                new GroupedSelectProjectionValidationRule(),
                new GroupedHavingValidationRule(),
