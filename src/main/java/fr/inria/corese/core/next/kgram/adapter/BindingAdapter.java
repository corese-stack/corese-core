...
public record BindingAdapter(Binding delegate) implements BindingContext {
    ...
    public void visit(Object e, Object g, Object m1, Object m2) {
        try {
            ...
            if (e instanceof fr.inria.corese.core.next.kgram.core.Exp &&
                    (g == null || g instanceof Node) &&
                    (m1 == null || m1 instanceof fr.inria.corese.core.next.kgram.core.Mappings) &&
                    (m2 == null || m2 instanceof fr.inria.corese.core.next.kgram.core.Mappings)) {

                delegate.visit(
                        (fr.inria.corese.core.next.kgram.core.Exp) e,
                        (Node) g,
                        (fr.inria.corese.core.next.kgram.core.Mappings) m1,
                        (fr.inria.corese.core.next.kgram.core.Mappings) m2
                );
                return;
            }
