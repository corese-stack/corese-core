package fr.inria.corese.core.next.data.impl.io.serializer.option;
...
public abstract class AbstractTFamilyOptions extends AbstractSerializerOptions implements UsesPrefixOptions, PrettyPrintOptions {
     ...
     */
    protected final PrefixOrdering prefixOrdering;
    /**
     ...
     */
    protected final BlankNodeStyle blankNodeStyle; // [] vs _:id
    /**
     ...
     */
    @Override
    public PrefixHandler getPrefixMapping() {
     ...
     *
     * @return The {@link BlankNodeStyle} for blank node serialization.
     */
    public BlankNodeStyle getBlankNodeStyle() {
    ...
    public abstract static class AbstractTFamilyBuilder<S extends AbstractTFamilyBuilder<S>> extends AbstractBuilder<S> {
        ...
        protected PrefixOrdering prefixOrdering = PrefixOrdering.ALPHABETICAL;
        ...
        protected BlankNodeStyle blankNodeStyle = BlankNodeStyle.NAMED;
        ...
        protected AbstractTFamilyBuilder(IOOptions otherOptions) {
            ...
            if(otherOptions instanceof UsesPrefixOptions usesPrefixOptions) {
                ...
                PrefixHandler copiedPrefixHandler = new PrefixHandler(false);
                copiedPrefixHandler.copyFrom(usesPrefixOptions.getPrefixMapping());
                this.prefixHandler(copiedPrefixHandler);
            }
         ...
         *
         * @param prefixOrdering The {@link PrefixOrdering} to set. Must not be null.
         * @return The builder instance for fluent chaining.
         * @throws NullPointerException if the provided policy is null.
         */
        public S prefixOrdering(PrefixOrdering prefixOrdering) {
         ...
         *
         * @param blankNodeStyle The {@link BlankNodeStyle} to set. Must not be null.
         * @return The builder instance for fluent chaining.
         * @throws NullPointerException if the provided style is null.
         */
        public S blankNodeStyle(BlankNodeStyle blankNodeStyle) {
