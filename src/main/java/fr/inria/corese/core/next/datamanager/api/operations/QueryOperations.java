...
public interface QueryOperations {
     ...
     */
    Stream<Statement> query(StatementPattern pattern) throws StorageException;
     ...
     * @throws IllegalArgumentException if pattern is null
     */
    boolean exists(StatementPattern pattern) throws StorageException;
     ...
     * @throws StorageException     if filter fails
     * @throws IllegalArgumentException if pattern is null
     */
    Model filter(StatementPattern pattern) throws StorageException;
}