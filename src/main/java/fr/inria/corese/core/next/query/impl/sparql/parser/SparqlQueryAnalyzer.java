...
import fr.inria.corese.core.next.query.impl.sparql.parser.listener.*;
import fr.inria.corese.core.next.query.impl.sparql.parser.semantic.validator.SparqlQuerySemanticValidator;
...
final class SparqlQueryAnalyzer {
    ...
    private SyntaxAnalysis analyzeSyntax(Reader reader, SparqlParserOptions options) throws IOException {
        ...
        try {
            ...
            fr.inria.corese.core.next.generated.antlr.SparqlParser parser =
                    new fr.inria.corese.core.next.generated.antlr.SparqlParser(tokens);
            ...
            if (errorListener.hasErrors()) {
                return new SyntaxAnalysis(
                        null,
                        new QueryValidationResult(errorListener.getDiagnostics()),
                        blankNodeLabels);
            }
    ...
    private QueryAst buildAst(
        ...
        fr.inria.corese.core.next.generated.antlr.SparqlParser.QueryContext root =
                (fr.inria.corese.core.next.generated.antlr.SparqlParser.QueryContext) tree;
        ...
        if (root.updateUnit() != null) {
            ...
            SparqlAntlrDispatcher updateListener = new SparqlAntlrDispatcher(List.of(
                    ...
                    new MoveUpdateAstListener(updateBuilder),
                    new InsertDataUpdateAstListener(updateBuilder),
                    new DeleteDataUpdateAstListener(updateBuilder),
                    new DeleteWhereUpdateAstListener(updateBuilder),
                    new ModifyUpdateAstListener(updateBuilder),
                    new SelectQueryAstListener(updateBuilder),
                    new HavingAstListener(updateBuilder),
                    new SolutionModifierAstListener(updateBuilder),
                    new ValuesAstListener(updateBuilder),
