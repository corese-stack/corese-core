 ...
 *
 */
public class UnionAstListener extends AbstractSparqlAstListener {

    /**
     * Constructs a {@code UnionAstListener} bound to the given AST builder.
     *
     * @param builder the {@link SparqlAstBuilder} that will receive UNION lifecycle events
     */
    public UnionAstListener(SparqlAstBuilder builder) {
        super(builder);
    }
