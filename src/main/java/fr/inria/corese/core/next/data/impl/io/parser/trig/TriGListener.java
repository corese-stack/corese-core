...
import fr.inria.corese.core.next.generated.antlr.TriGBaseListener;
import fr.inria.corese.core.next.generated.antlr.TriGParser;
 ...
 */
public class TriGListener extends TriGBaseListener {
     ...
     */
    public TriGListener(Model model, ValueFactory factory, IOOptions options, String baseURI) {
     ...
     */
    public TriGListener(Model model, ValueFactory factory, IOOptions options) {
        String baseURI;
     ...
     * @throws ParsingException if a standalone collection appears outside graph blocks
     */
    private void validateStandaloneCollection(TriGParser.Triples2Context ctx) {
        if (!insideGraphBlock) {
            ...
            if (objects.isEmpty()) {
                throw new ParsingException("Free-standing list of zero-elements outside {} : bad syntax");
            } else {
                throw new ParsingException("Free-standing list outside {} : bad syntax");
            }
        }
    }
     ...
     * @throws ParsingException if the object type is unsupported
     */
    private Value extractObject(TriGParser.ObjectContext ctx) {
        ...
        throw new ParsingException("Unsupported object: " + ctx.getText());
    }
     ...
     * @throws ParsingException if the blank node format is unsupported
     */
    private Resource extractBlank(TriGParser.BlankContext ctx) {
        ...
        throw new ParsingException("Unsupported blank node: " + ctx.getText());
    }
    ...
    private Resource extractSubject(TriGParser.SubjectContext ctx) {
        ...
        throw new ParsingException("Unsupported subject: " + ctx.getText());
    }
     ...
     * @throws ParsingException if IRI resolution fails or type is unsupported
     */
    private Resource extractLabelOrSubject(TriGParser.LabelOrSubjectContext ctx) {
        if (ctx.iri() != null) {
            ...
            try {
                ...
                throw new ParsingException("Failed to resolve IRI: " + iriText, e);
            }
        }
        ...
        throw new ParsingException("Unsupported label or subject: " + ctx.getText());
    }
    ...
    private static class TriGListenerDelegate extends AbstractTurtleTriGListener {
         ...
         * @throws ParsingException if statement cannot be added to any graph
         */
        @Override
        public void safeAddStatement(Resource subject, IRI predicate, Value object) {
            try {
                ...
                if (currentGraph != null) {
                    try {
                        model.add(subject, predicate, object, (Resource) null);
                    } catch (Exception e2) {
