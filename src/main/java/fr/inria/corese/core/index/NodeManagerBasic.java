...
public class NodeManagerBasic {
    ...
    private Map<Node, PredicateList> nodePredicateTable;
    ...
    public Map<Node, PredicateList> getPredicateTable() {
        return nodePredicateTable;
    }

    public void setPredicateTable(Map<Node, PredicateList> ptable) {
