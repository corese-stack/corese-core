    ...
    public Node getNode(ResultSet rs, int i) throws SQLException {
        ...
        switch (rs.getMetaData().getColumnType(i)) {
            ...
            case java.sql.Types.DECIMAL:
                dt = DatatypeMap.newInstance(rs.getInt(i));
                break;

            case java.sql.Types.BIGINT:
                dt = DatatypeMap.newInstance(rs.getLong(i));
                break;

            case java.sql.Types.FLOAT:
                dt = DatatypeMap.newInstance(rs.getFloat(i));
                break;

            case java.sql.Types.DOUBLE:
                dt = DatatypeMap.newInstance(rs.getDouble(i));
                break;

            case java.sql.Types.BOOLEAN:
                dt = DatatypeMap.newInstance(rs.getBoolean(i));
                break;
