...
import fr.inria.corese.core.sparql.datatype.extension.*;
...
public class DatatypeMap implements Cst, RDF, DatatypeValueFactory {
    ...
    public static IDatatype getValue(Object value) {
        ...
        return DatatypeMap.castObject(value);
    }
...
//    }
    ...
    public static void setNumber(JSONObject json, String key, IDatatype dt) {
        switch (dt.getCode()) {
            case DECIMAL:
                json.put(key, dt.doubleValue());
                break;
            case DOUBLE:
                json.put(key, dt.doubleValue());
                break;
            case FLOAT:
                json.put(key, dt.floatValue());
                break;
            default:
                json.put(key, dt.intValue());
                break;
        }
    }
    ...
    public void init2() {
        ...
        define(RDFSLITERAL, IDatatype.Datatype.LITERAL);
        define(rdflangString, IDatatype.Datatype.LITERAL);
        define(XMLLITERAL, IDatatype.Datatype.XMLLITERAL);
        define(xsdboolean, IDatatype.Datatype.BOOLEAN);
        define(xsdanyURI, IDatatype.Datatype.URI_LITERAL);
        define(xsdstring, IDatatype.Datatype.STRING);
        define(RDFSRESOURCE, IDatatype.Datatype.URI);
        ...
        define(xsddouble, IDatatype.Datatype.DOUBLE);
        define(xsdfloat, IDatatype.Datatype.FLOAT);
        define(xsddecimal, IDatatype.Datatype.DECIMAL);
        define(xsdinteger, IDatatype.Datatype.INTEGER);
        ...
        define(xsddate, IDatatype.Datatype.DATE);
        define(xsddateTime, IDatatype.Datatype.DATETIME);

        define(xsdday, IDatatype.Datatype.DAY);
        define(xsdmonth, IDatatype.Datatype.MONTH);
        define(xsdyear, IDatatype.Datatype.YEAR);

        define(xsddaytimeduration, IDatatype.Datatype.DURATION);
