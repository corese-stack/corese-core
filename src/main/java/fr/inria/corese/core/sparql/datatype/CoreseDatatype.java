...
public class CoreseDatatype
    ...
    static IDatatype.Datatype code = Datatype.UNDEFINED;

    static HashMap<IDatatype.Datatype, Class> javaClassMap;
    @Deprecated
    ...
    static void init() {
        ...
        define(IDatatype.Datatype.INTEGER, int.class);
        define(IDatatype.Datatype.DOUBLE, double.class);
        define(IDatatype.Datatype.DECIMAL, double.class);
        define(IDatatype.Datatype.FLOAT, double.class);
        define(IDatatype.Datatype.BOOLEAN, boolean.class);
        define(IDatatype.Datatype.STRING, String.class);
        define(IDatatype.Datatype.LITERAL, String.class);
        define(IDatatype.Datatype.URI, String.class);
    }
    ...
    static void define(IDatatype.Datatype i, Class c) {
    ...
    public String toSparql(boolean prefixDatatype, boolean displayDatatype, boolean skipUndefPrefix, NSManager nsm) {
        ...
        if (getCode() == IDatatype.Datatype.INTEGER && !displayDatatype && getDatatypeURI().equals(XSD.xsdinteger)
                && (!(value.startsWith("0") && value.length() > 1))) {
            // display integer value as is (without datatype)
        } else if (getCode() == IDatatype.Datatype.BOOLEAN && !displayDatatype &&
                (getLabel().equals(CoreseBoolean.STRUE) || getLabel().equals(CoreseBoolean.SFALSE))) {
        } else if (getCode() == IDatatype.Datatype.STRING || (getCode() == IDatatype.Datatype.LITERAL && !hasLang())) {
            value = protect(value);
    ...
    public int compareTo(IDatatype d2) {
        IDatatype.Datatype code = getCode(), other = d2.getCode();
        boolean b = false;
        ...
        switch (other) {
            ...
            case UNDEF:
                if (code == IDatatype.Datatype.UNDEF) {
        ...
        switch (code) {
            ...
            case STRING:
                if (other == IDatatype.Datatype.LITERAL) {
