...
public class Pattern {
    ...
    String undef() {
        StringBuilder sb = new StringBuilder();
        sb.append("UNDEF ".repeat(stack.getVariables().size()));
        return sb.toString();
    }
