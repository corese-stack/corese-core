...
public class CoreseTypeTest {
    ...
    public void setUp() {
        ...
        testDatatypeIRI = CoreDatatype.XSD.STRING.getIRI();
        testCoreDatatype = CoreDatatype.XSD.STRING;
    }
    ...
    public void testCoreseTypedConstructorWithString() {
        ...
        assertEquals(CoreDatatype.XSD.STRING, coreseTyped.getCoreDatatype());
        assertEquals(testValue, coreseTyped.getLabel());
    }
    ...
    public void testSetCoreDatatype() {
        ...
        assertThrows(IncorrectOperationException.class, () -> {
            coreseTyped.setCoreDatatype(CoreDatatype.XSD.STRING);
        });
    }
    ...
    public void testConstructorWithNullDatatype() {
        ...
        assertEquals(CoreDatatype.XSD.STRING.getIRI(), coreseTyped.getDatatype());
        assertEquals(CoreDatatype.XSD.STRING, coreseTyped.getCoreDatatype());
        assertEquals(testValue, coreseTyped.getLabel());
    }
