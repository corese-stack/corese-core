...
class StatementPatternTest {
    ...
    void testWildcardCheckers() {
        ...
        assertTrue(allWildcards.isSubject());
        assertTrue(allWildcards.isPredicate());
        assertTrue(allWildcards.isObject());
        assertTrue(allWildcards.isContexts());
        ...
        assertFalse(withSubject.isSubject());
        assertTrue(withSubject.isPredicate());
        assertTrue(withSubject.isObject());
        assertTrue(withSubject.isContexts());
    }
