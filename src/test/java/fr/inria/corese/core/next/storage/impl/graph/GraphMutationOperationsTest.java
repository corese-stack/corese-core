...
/**
 * Unit tests for GraphMutationOperations.
 */
class GraphMutationOperationsTest {
    ...
    private GraphMutationOperations mutationOps;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        mutationOps = new GraphMutationOperations(mockAdapter);
    }
    ...
    class ConstructorTests {
        ...
        void shouldThrowWhenAdapterIsNull() {
            assertThrows(IllegalArgumentException.class,
                () -> new GraphMutationOperations(null));
        }
    }
