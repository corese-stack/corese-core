 ...
 */
class RDFXMLSerializerOptionsTest {
    ...
    void defaultConfig_shouldReturnExpectedDefaults() {
        ...
        assertEquals(PrefixOrdering.ALPHABETICAL, config.getPrefixOrdering(), "Default prefixOrdering should be ALPHABETICAL for XML");
        ...
        assertEquals(LiteralDatatypePolicy.ALWAYS_TYPED, config.getLiteralDatatypePolicy(), "Default literalDatatypePolicy should be ALWAYS_TYPED for XML");
    ...
    void builder_shouldAllowSettingCustomPrefixHandler() {
        ...
        PrefixHandler resultHandler = config.getPrefixMapping();
